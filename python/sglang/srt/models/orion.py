...
# Adapted from:
# https://github.com/vllm-project/vllm/blob/main/vllm/model_executor/models/orion.py
    ...
    def __init__(
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda idx, prefix: OrionDecoderLayer(
                config, quant_config, layer_id=idx, prefix=prefix
            ),
...
class OrionForCausalLM(nn.Module):
    def __init__(
        ...
        self.model = OrionModel(
            config, quant_config, prefix=add_prefix(prefix, "model")
        )
